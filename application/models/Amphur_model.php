...
class Amphur_model extends CI_Model {
 ...
 function amphur_count_id($province_id){
    $language = $this->lang->language['lang'];
    ...
    public function getSelectAmphur($amphur_id = 0, $default = 0,$name = "amphur_id"){
    ...
    public function get_amphur($province_id,$amphur_id=0, $amphur_id=null, $status=null, $order='order_by', $order_type='Asc', $limit_start = 0, $listpage = 20000){
