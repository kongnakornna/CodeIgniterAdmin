<?php
class Hardware2test_model extends CI_Model{
   ...
   public function get_hardwarena($hardware_id_map=null, $status=1) {
    ...
    public function getSelecthw_pump_id($default = 0,$name = "hw_pump_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
	    	...
	    	for($i=0;$i<count($rows);$i++){
	    		$row = @$rows[$i];
	    		$opt[]	= makeOption($row['hardware_id_map'], $row['hardware_name'].' IP:'.$row['hardware_ip']);
	    	}
	    	return selectList( $opt, $name, 'class="form-control"', 'value', 'text',$default);
    }
    
    public function getSelectflow_id($default = 0,$name = "flow_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
    ...
    public function getSelectcurrent_id($default = 0,$name = "current_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
    ...
    public function getSelectvoltage_id($default = 0,$name = "voltage_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
    ...
    public function getSelectpower_id($default = 0,$name = "power_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
    ...
    public function getSelectcontrol_id($default = 0,$name = "control_id"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
    ...
    public function getSelect($default = 0,$name = "hardware_id"){
     ...
     public function getSelecthwmap($default = 0,$name = "hardware_id_map"){
    		$language = $this->lang->language;
    		 //debug($language); die();    		
    		$first = "--- ".$language['please_select']." ---";
