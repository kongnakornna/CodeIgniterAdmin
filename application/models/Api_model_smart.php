...
class Api_model_smart extends CI_Model {
       ...
       /*************Sub menu Active****************/
									...
									if($sub == 1)
											$list_data .= '<li '.$curactive.'>
												<a href="#" title="'.$title.'">
														<i class="fa fa-lg fa-fw '.$icon.'"></i><span class="menu-item-parent">'.$title.'</span>
											...
											$list_data .= '<li '.$classactive.'>
													<a href="'.base_url($url).'">
													<i class="fa fa-lg fa-fw '.$icon.'"></i><span class="menu-item-parent">'.$title.'</span></a>
													...
													//if($sub_url == strtolower($this->uri->segment(1))){
														...
														$list_data .= '<li '.$classactive.'>
																		<a href="'.base_url($sub_url).'">
																			<i class="fa fa-lg fa-fw fa fa-caret-right"></i>'.$subtitle.'  </a>
