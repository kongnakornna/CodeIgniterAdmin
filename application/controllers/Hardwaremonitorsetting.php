...
class Hardwaremonitorsetting extends MY_Controller {
	...
	public function listview($pageIndex=1){
		...
		$language = $this->lang->language;
          ...
          $breadcrumb[] = '<a href="'.base_url('hardwaremonitorsetting/add').'">'.$language['add'].$language['hardwaremonitorsetting'].'</a>';
	...
	public function listsensor($id){
		...
		$language = $this->lang->language;
          $lang = $this->lang->language['lang'];
		 $breadcrumb[] = '<a href="'.base_url('hardware').'">'.$language['hardware'].'</a>';
          $breadcrumb[] = '<a href="'.base_url('hardwaremonitorsetting').'">'.$language['hardwaremonitorsetting'].'</a>';
	...
	public function update(){
			...
			$breadcrumb[] = $language['hardware'];
			 ...
			 if ($this->input->server('REQUEST_METHOD') === 'POST'){
                    ...
                    redirect('hardwaremonitorsetting');
			 }
