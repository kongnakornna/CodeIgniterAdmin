...
class Hardware extends MY_Controller {
	...
	public function listview($pageIndex=1){
		...
		$language = $this->lang->language;
          ...
          $breadcrumb[] = '<a href="'.base_url('hardwarecontrolconfig').'">'.$language['hardwarecontrolconfig'].'</a>';		$breadcrumb[] = '<a href="'.base_url('hardwaremonitorsetting').'">'.$language['hardwaremonitorsetting'].'</a>';
          $breadcrumb[] = '<a href="'.base_url('sensorconfig').'">'.$language['sensorconfig'].'</a>';
		$breadcrumb[] = '<a href="'.base_url('hardware/add').'">'.$language['add'].$language['hardware'].'</a>';
