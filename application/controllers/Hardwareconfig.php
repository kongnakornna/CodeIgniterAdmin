...
class Hardwareconfig extends MY_Controller {
	...
	public function listview($pageIndex=1){
		...
		$breadcrumb[] = '<a href="'.base_url('hardwareconfig/add').'">'.$language['add'].$language['hardwareconfig'].'</a>';
	...
	public function add(){
			...
			$ListSelect = $this->Api_model_na->user_menu($this->session->userdata('admin_type'));		
			$language = $this->lang->language;			
			$breadcrumb[] = '<a href="'.base_url('hardwareconfig').'">'.$language['hardwareconfig'].'</a>';
	...
	public function save(){
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST'){
				...
				$forbiddenna=$language['forbidden'];
					...
					echo '<script language="javascript">alert("'.$housenn1.'");top.location="'.base_url('hardwareconfig/edit/'.$condition_group_id2).'"; window.history.back(-1);</script>';	
					}else if($condition_group_id2=='' || $condition_group_id2==0){
					echo '<script language="javascript">alert("'.$housenn1.'");top.location="'.base_url('hardwareconfig/add/').'"; window.history.back(-1);</script>';	
					}
					exit();
...
echo '<script language="javascript">alert("'.$minutenn1.'");top.location="'.base_url('hardwareconfig/edit/'.$condition_group_id2).'";</script>';	
				 }else if($condition_group_id2=='' || $condition_group_id2==0){
echo '<script language="javascript">alert("'.$minutenn1.'");top.location="'.base_url('hardwareconfig/add/').'";</script>';	
				 }
				 exit();
				}}#################****Date****###############
...
if($condition_group_id2!=='' || $condition_group_id2!==0){
 ;
echo '<script language="javascript">alert("'.$datenn1.'");top.location="'.base_url('hardwareconfig/edit/'.$condition_group_id2).'";</script>';
				 }else if($condition_group_id2=='' || $condition_group_id2==0){
echo '<script language="javascript">alert("'.$datenn1.'");top.location="'.base_url('hardwareconfig/add/').'";</script>';		
				 }
				 exit();
				}#################****Month****###############
...
if($condition_group_id2!=='' || $condition_group_id2!==0){
 ;
echo '<script language="javascript">alert("'.$monthnn1.'");top.location="'.base_url('hardwareconfig/edit/'.$condition_group_id2).'";</script>';	
				 }else if($condition_group_id2=='' || $condition_group_id2==0){
echo '<script language="javascript">alert("'.$monthnn1.'");top.location="'.base_url('hardwareconfig/add/').'";</script>';		
				 }
				 exit();
				}################################
